export const en_lang = {
  ...
  referrals: {
    ...
    description: "Invite friends to the game and receive rewards when they reach new levels!",
    your_link: "Your referral link:",
    copy_link: "Copy Link",
    copied: "Copied!",
    rewards: "Rewards for referrals:",
    reward1: "When a friend reaches level 15, you receive 50 Qi stones.",
    reward2: "When a friend reaches level 20, you receive 100 Qi stones.",
    reward3: "When a friend reaches level 25, you receive 150 Qi stones.",
    referrer: "You were referred:",
    your_referrals: "Your Referrals",
    no_referrals: "You have not referred any friends yet.",
  },
  profile: {
    ...
    stats: {
      ...
      defeats: "Defeats",
      wins: "Wins",
      meditation: "Meditation hours",
      spirit_path: "Spirit Path minutes",
      mined_stones: "Mined",
      missions: "Missions",
      looted: "Looted",
      lost: "Lost",
  ...
  facts: {
    ...
    fight: {
      fight_win1: "You atack and won against {opponent}, receiving:",
      fight_win2: "You was attacked by {opponent} and won, receiving:",
      fight_lose1: "You atack and lost against {opponent}. You lost:",
      fight_lose2: "You was attacked by {opponent} and lost. You lost:",
    },
    notification: {
