...
export const ru_lang: Messages = {
  ...
  referrals: {
    ...
    description: "Пригласите друзей в игру и получите награды, когда они достигнут новых уровней!",
    your_link: "Ваша реферальная ссылка:",
    copy_link: "Копировать ссылку",
    copied: "Скопировано!",
    rewards: "Награды за рефералов:",
    reward1: "Когда друг достигает уровня 15, вы получаете 50 камней ци.",
    reward2: "Когда друг достигает уровня 20, вы получаете 100 камней ци.",
    reward3: "Когда друг достигает уровня 25, вы получаете 150 камней ци.",
    referrer: "Вы были приглашены:",
    your_referrals: "Ваши рефералы",
    no_referrals: "Вы еще не пригласили друзей.",
  },
  profile: {
    ...
    stats: {
      ...
      defeats: "Поражений",
      wins: "Побед",
      meditation: "Часов медитации",
      spirit_path: "Минут на пути духа",
      mined_stones: "Добыто",
      missions: "Миссий",
      looted: "Награблено",
      lost: "Потеряно",
  ...
  headquarter: {
    missions: {
      ...
      daily_missions: "Ежедневные",
      permanents: "Постоянные",
      types: {
        MEDITATION: {
  ...
  city: {
    ...
    place_of_power: {
      title: "Место силы",
      description:
        "Место силы - священное место, где сходятся энергии мира. Здесь воины и мудрецы приходят, чтобы восстановить свою Ци и обрести просветление. Те, кто медитирует на этой святой земле, находят усиление своей духовной силы, позволяя им противостоять большим испытаниям впереди.",
    },
    bank: {
      title: "Банк",
      description:
        "Банк Ци - это святилище богатства и безопасности в сердце Цитадели. Здесь культиваторы могут обезопасить свои тяжело заработанные камни ци и духовные кристаллы, гарантируя защиту своих ресурсов от неопределенностей внешнего мира. Банк предлагает не только безопасность, но и возможности для роста, позволяя вкладчикам зарабатывать проценты на своих сбережениях и инвестировать в свои будущие пути культивации.",
      success_exchange: "Обмен успешно завершен",
    },
  },
  fight: {
